...
filtered_expression <- varFilter(cleaned_tx_abundance_unique_log2_matrix, var.fun = IQR, var.cutoff = 0.8)
nrow(filtered_expression) #Sobraram 228 genes com expres
